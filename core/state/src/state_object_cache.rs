...
pub struct StateObjectCache {
    ...
    deposit_cache: RwLock<HashMap<CodeAddress, Option<DepositList>>>,
    // TODO: etc.
}
...
impl StateObjectCache {
    ...
    pub fn get_deposit<StateDb: StateDbOps>(
        &self, contract_address: &Address, db: &StateDb,
    ) -> Result<
        GuardedValue<
            RwLockReadGuard<HashMap<CodeAddress, Option<DepositList>>>,
...
use primitives::{CodeInfo, DepositList};
