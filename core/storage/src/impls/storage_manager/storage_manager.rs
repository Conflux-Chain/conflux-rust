...
impl StorageManager {
    ...
    ) -> Result<()>
    {
        ...
        //  We will remove this hack and fix tests quickly.
        ...
        let mut first_available_state_height = if confirmed_snapshot_height > 0
        {
                ...
                if snapshot_info.height == confirmed_snapshot_height {
                    ...
                    if snapshot_epoch_id.eq(prev_snapshot_epoch_id) {
                        if extra_snapshots_to_keep(
                            ...
                            checkpoint_height = snapshot_info.height;
                        } else {
        ...
        {
            {
                ...
                first_available_state_height = checkpoint_height;
