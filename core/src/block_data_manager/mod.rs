...
use crate::{
    ...
    storage::{
        state_manager::StateIndex, GuardedValue, StateRootWithAuxInfo,
    ...
    pub fn true_genesis_state_root(&self) -> StateRootWithAuxInfo {
        self.storage_manager
            .get_state_no_commit(StateIndex::new_for_readonly(
                ...
                &StateRootWithAuxInfo::genesis(&self.true_genesis.hash()),
            ))
            .unwrap()
            .unwrap()
            .get_state_root()
