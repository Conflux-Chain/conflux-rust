...
pub fn epoch(block_height: u64) -> u64 {
...
pub fn get_cache_size(block_height: u64) -> usize {
	// TODO: Memoise
	let mut sz: u64 = CACHE_BYTES_INIT + CACHE_BYTES_GROWTH * (block_height / ETHASH_EPOCH_LENGTH);
...
pub fn get_data_size(block_height: u64) -> usize {
	// TODO: Memoise
	let mut sz: u64 = DATASET_BYTES_INIT + DATASET_BYTES_GROWTH * (block_height / ETHASH_EPOCH_LENGTH);
