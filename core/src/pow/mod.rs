...
impl ProofOfWorkProblem {
    ...
    #[inline]
    pub fn validate_hash(&self, hash: &H256) -> bool {
        BigEndianHash::into_uint(hash) < self.boundary
            || self.boundary == ProofOfWorkProblem::NO_BOUNDARY
    }
