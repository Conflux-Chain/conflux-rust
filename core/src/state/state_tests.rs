...
fn checkpoint_get_storage_at() {
    ...
    state
        .commit(BigEndianHash::from_uint(&U256::from(1u64)), &mut None)
        .unwrap();
    state.clear();
...
fn create_contract_fail() {
    ...
    state
        .commit(BigEndianHash::from_uint(&U256::from(1)), &mut None)
        .unwrap();
}
...
fn create_contract_fail_previous_storage() {
    ...
    state
        .commit(BigEndianHash::from_uint(&U256::from(2)), &mut None)
        .unwrap();
}
