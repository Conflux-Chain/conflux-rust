...
/// let expected = vec![
///     0xc0, 0xa8, 0x01, 0x01, 0x03, 0x00, 0x00, 0x00, 0x41, 0x1f, 0x42, 0x1f,
///     0x43, 0x1f, 0x01, 0x88, 0x13, 0x00, 0x00, 0x00,
/// ];
...
impl Serializer {
    ...
    /// serialized data.
    fn end(self) -> Vec<u8> { self.output }
...
impl<'a> ser::Serializer for &'a mut Serializer {
    ...
    fn serialize_i8(self, v: i8) -> Result<()> { self.serialize_u8(v as u8) }
    ...
    fn serialize_none(self) -> Result<()> { self.serialize_u8(0) }

    // A present optional is represented as `01` followed by the serialized
    // value
