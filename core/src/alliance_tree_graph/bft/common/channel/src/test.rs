...
// Fork the unit tests into separate processes to avoid the conflict that these
// tests executed in multiple threads may manipulate TEST_COUNTER at the same
// time.
rusty_fork_test! {
#[test]
