...
/// It contains bunch of boilerplate hacks to make output of test look not too
/// verbose(but still have some logs)
///
...
/// Message: log message
///
/// It sets default log level to INFO for all modules, and debug for specific
/// module, usually module that unit test belongs to
///
...
impl Drain for SimpleDrain {
    ...
    fn log(
        &self, record: &Record, _values: &OwnedKVList,
...
/// Logger prefix can be used to separate logs from those multiple simulated
/// instances
