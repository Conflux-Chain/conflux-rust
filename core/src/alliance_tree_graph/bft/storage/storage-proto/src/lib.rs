...
//! This crate provides Protocol Buffers definitions for the services provided
//! by the [`storage_service`](../storage_service/index.html) crate.
//!
//! The protocol is documented in Protocol Buffers sources files in the `.proto`
//! extension and the documentation is not viewable via rustdoc. Refer to the
...
//!       * In [`proto::storage`] are structs corresponding to our Protocol
//!         Buffers messages.
//!       * In [`proto::storage_grpc`] live the [GRPC](grpc.io) client struct
//!         and the service trait
//! which correspond to our Protocol Buffers services.
//!   2. Structs we wrote manually as helpers to ease the manipulation of the
//! above category of structs. By implementing the
//! [`TryFrom`](std::convert::TryFrom) and [`From`](std::convert::From) traits,
//! these structs convert from/to the above category of structs in a single
//! method call and in that process data integrity check can be done. These live
//! right in the root module of this crate (this page).
//!
//! This is provided as a separate crate so that crates that use the storage
//! service via [`storage-client`](../storage-client/index.html) don't need to
//! depending on the entire [`storage-service`](../storage-service/index.html).
...
impl TryFrom<crate::proto::storage::GetLatestStateRootResponse>
    for GetLatestStateRootResponse
{
    type Error = Error;

    fn try_from(
        proto: crate::proto::storage::GetLatestStateRootResponse,
    ) -> Result<Self> {
...
impl From<GetLatestStateRootResponse>
    for crate::proto::storage::GetLatestStateRootResponse
{
...
impl GetLatestAccountStateRequest {
    pub fn new(address: AccountAddress) -> Self { Self { address } }
}

impl TryFrom<crate::proto::storage::GetLatestAccountStateRequest>
    for GetLatestAccountStateRequest
{
    type Error = Error;

    fn try_from(
        proto: crate::proto::storage::GetLatestAccountStateRequest,
    ) -> Result<Self> {
...
impl From<GetLatestAccountStateRequest>
    for crate::proto::storage::GetLatestAccountStateRequest
{
    ...
    for GetLatestAccountStateResponse
{
    ...
    fn try_from(
        proto: crate::proto::storage::GetLatestAccountStateResponse,
    ) -> Result<Self> {
...
impl From<GetLatestAccountStateResponse>
    for crate::proto::storage::GetLatestAccountStateResponse
{
...
impl TryFrom<crate::proto::storage::SaveTransactionsRequest>
    for SaveTransactionsRequest
{
    type Error = Error;

    fn try_from(
        proto: crate::proto::storage::SaveTransactionsRequest,
    ) -> Result<Self> {
...
impl From<SaveTransactionsRequest>
    for crate::proto::storage::SaveTransactionsRequest
{
    fn from(request: SaveTransactionsRequest) -> Self {
        let txns_to_commit =
            request.txns_to_commit.into_iter().map(Into::into).collect();
        let first_version = request.first_version;
        let ledger_info_with_signatures =
            request.ledger_info_with_signatures.map(Into::into);
...
impl GetTransactionsRequest {
    /// Constructor.
    pub fn new(
        start_version: Version, batch_size: u64, ledger_version: Version,
        fetch_events: bool,
    ) -> Self
    {
...
impl TryFrom<crate::proto::storage::GetTransactionsRequest>
    for GetTransactionsRequest
{
    type Error = Error;

    fn try_from(
        proto: crate::proto::storage::GetTransactionsRequest,
    ) -> Result<Self> {
...
impl From<GetTransactionsRequest>
    for crate::proto::storage::GetTransactionsRequest
{
...
impl TryFrom<crate::proto::storage::GetTransactionsResponse>
    for GetTransactionsResponse
{
    type Error = Error;

    fn try_from(
        proto: crate::proto::storage::GetTransactionsResponse,
    ) -> Result<Self> {
...
impl From<GetTransactionsResponse>
    for crate::proto::storage::GetTransactionsResponse
{
...
impl TreeState {
    pub fn new(
        version: Version, ledger_frozen_subtree_hashes: Vec<HashValue>,
...
impl TryFrom<crate::proto::storage::TreeState> for TreeState {
    ...
    fn try_from(proto: crate::proto::storage::TreeState) -> Result<Self> {
        let account_state_root_hash =
            HashValue::from_slice(&proto.account_state_root_hash[..])?;
...
impl TryFrom<crate::proto::storage::GetStartupInfoResponse>
    for GetStartupInfoResponse
{
    type Error = Error;

    fn try_from(
        proto: crate::proto::storage::GetStartupInfoResponse,
    ) -> Result<Self> {
...
impl From<GetStartupInfoResponse>
    for crate::proto::storage::GetStartupInfoResponse
{
    ...
    for GetEpochChangeLedgerInfosRequest
{
    ...
    fn try_from(
        proto: crate::proto::storage::GetEpochChangeLedgerInfosRequest,
    ) -> Result<Self> {
        Ok(Self {
...
impl TryFrom<crate::proto::storage::BackupAccountStateRequest>
    for BackupAccountStateRequest
{
    type Error = Error;

    fn try_from(
        proto: crate::proto::storage::BackupAccountStateRequest,
    ) -> Result<Self> {
        Ok(Self {
...
impl From<BackupAccountStateRequest>
    for crate::proto::storage::BackupAccountStateRequest
{
...
impl BackupAccountStateResponse {
    /// Constructor.
    pub fn new(
        account_key: HashValue, account_state_blob: AccountStateBlob,
    ) -> Self {
        Self {
            account_key,
            account_state_blob,
...
impl TryFrom<crate::proto::storage::BackupAccountStateResponse>
    for BackupAccountStateResponse
{
    type Error = Error;

    fn try_from(
        proto: crate::proto::storage::BackupAccountStateResponse,
    ) -> Result<Self> {
...
impl From<BackupAccountStateResponse>
    for crate::proto::storage::BackupAccountStateResponse
{
