...
pub fn make_proposal_with_qc_and_proof<P: Payload>(
    payload: P, round: Round, proof: Proof, qc: QuorumCert,
...
pub fn make_proposal_with_parent<P: Payload>(
    payload: P, round: Round, parent: &VoteProposal<P>,
    committed: Option<&VoteProposal<P>>, validator_signer: &ValidatorSigner,
) -> VoteProposal<P>
{
