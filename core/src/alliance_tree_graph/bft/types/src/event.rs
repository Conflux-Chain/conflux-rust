...
impl EventKey {
    ...
    pub fn new(key: [u8; EVENT_KEY_LENGTH]) -> Self { EventKey(key) }
...
// Rust doesn't support deriving traits for array size greater than 32. We'll
// implement those traits by hand for now
...
impl Default for EventKey {
    fn default() -> Self { Self([0; EVENT_KEY_LENGTH]) }
}
