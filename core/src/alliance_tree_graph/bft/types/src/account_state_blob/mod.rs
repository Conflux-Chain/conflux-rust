...
use crate::{
    ...
    account_config::get_account_resource_or_default, ledger_info::LedgerInfo,
...
impl From<AccountStateBlob> for crate::proto::types::AccountStateBlob {
    fn from(blob: AccountStateBlob) -> Self { Self { blob: blob.blob } }
}
...
impl TryFrom<crate::proto::types::AccountStateWithProof>
    for AccountStateWithProof
{
    type Error = Error;

    fn try_from(
        mut proto: crate::proto::types::AccountStateWithProof,
    ) -> Result<Self> {
        Ok(Self::new(
            proto.version,
            proto
...
impl From<AccountStateWithProof>
    for crate::proto::types::AccountStateWithProof
{
