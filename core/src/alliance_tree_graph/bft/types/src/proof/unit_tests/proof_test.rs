...
use crate::{
    ...
    proof::{
        ...
        EventAccumulatorInternalNode, EventAccumulatorProof, EventProof,
        SparseMerkleInternalNode, SparseMerkleLeafNode, SparseMerkleProof,
        TestAccumulatorInternalNode, TestAccumulatorProof,
...
fn test_verify_transaction() {
    ...
    let proof =
        TransactionProof::new(ledger_info_to_transaction_info_proof, txn_info1);
