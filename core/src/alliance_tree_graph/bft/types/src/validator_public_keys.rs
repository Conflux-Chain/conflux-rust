...
/// and networking will has public signing and identity keys for creating secure
...
impl<PublicKey> ValidatorPublicKeys<PublicKey> {
    ...
    /// Returns the key that establishes a validator's identity in the p2p
    /// network
    ...
    for ValidatorPublicKeys<PublicKey>
{
    ...
    fn try_from(
        proto: crate::proto::types::ValidatorPublicKeys,
    ) -> Result<Self> {
