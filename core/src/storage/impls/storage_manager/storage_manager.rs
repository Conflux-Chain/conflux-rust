...
impl StorageManager {
    ...
    fn get_delta_db_name(snapshot_root: &MerkleHash) -> String {
    ...
    ) -> Result<Arc<DeltaMpt>>
    {
        let db = storage_manager
            .delta_db_manager
            .new_empty_delta_db(&Self::get_delta_db_name(snapshot_root))?;
