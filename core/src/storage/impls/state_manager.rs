...
impl StateManager {
    ...
    pub fn get_state_trees_internal(
        ...
        delta_root: Option<NodeRefDeltaMpt>, maybe_height: Option<u64>,
    ...
    ) -> Result<Option<StateTrees>>
    {
        ...
        if maybe_intermediate_trie.is_none() {
            ...
            intermediate_trie_root = match maybe_intermediate_trie
                .as_ref()
                .unwrap()
        ...
        Ok(Some(StateTrees {
            ...
            delta_trie_key_padding: delta_trie_key_padding.clone(),
