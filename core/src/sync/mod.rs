...
pub mod msg_sender {
    ...
    lazy_static! {
        ...
        static ref ON_STATUS_COUNTER: Arc<Meter> =
            register_meter_with_group("network_connection_data_counter", "on_status");
        ...
        static ref NEW_BLOCK_COUNTER: Arc<Meter> =
            register_meter_with_group("network_connection_data_counter", "new_block");
        ...
        static ref GET_BLOCKS_COUNTER: Arc<Meter> =
            register_meter_with_group("network_connection_data_counter", "get_blocks");
