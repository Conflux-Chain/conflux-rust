        ...
        if request.is_initial_request() {
            match Self::validate_blame_states(
                ...
                Some((
                    ...
                    if response.snapshot_state_root
                        != state_root_with_aux_info.state_root
                    {
                        warn!("ManifestResponse has invalid snapshot_root: should be {:?}", state_root_with_aux_info.state_root);
        ...
        Some((
            ...
            StateRootWithAuxInfo {
                ...
                aux_info: StateRootAuxInfo {
                    ...
                    // for the synced snapshot because it's kind of inaccurate.
