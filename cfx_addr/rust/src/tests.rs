...
fn testnet_20byte() {
    ...
    verify(
        ...
        &"F5BF48B397DAE70BE82B3CCA4793F8EB2B6CDAC9"
            .from_hex()
            .unwrap(),
        "cfx-test:13uvyj5kjzdee2z85cycmhwkz3njpv6ut4tnnk34e9",
    );
}
...
fn testnet_24byte() {
    ...
    verify(
        ...
        &"7ADBF6C17084BC86C1706827B41A56F5CA32865925E946EA"
            .from_hex()
            .unwrap(),
        "cfx-test:15xdrxp1e22bt1p1e1m2fd0uavuwmcm6b4jyjhra7m5axwe4",
    );
}
...
fn testnet_28byte() {
    ...
    verify(
        ...
        &"3A84F9CF51AAE98A3BB3A78BF16A6183790B18719126325BFC0C075B"
            .from_hex()
            .unwrap(),
        "cfx-test:18x89yefa6nek2hvpeksrwbac61rj2sse68jccjvzg60epsff85wn7u",
    );
}
...
fn testnet_32byte() {
    ...
    verify(
        ...
        &"3173EF6623C6B48FFD1A3DCC0CC6489B0A07BB47A37F47CFEF4FE69DE825C060"
            .from_hex().unwrap(),
        "cfx-test:1csr7vv64f3b93zx38yws36692dgm1xv8yhryhyfxx7yd7f84r0604aum3mhw",
    );
}
...
fn testnet_40byte() {
    ...
    verify(
        Network::Test,
        &"C07138323E00FA4FC122D3B85B9628EA810B3F381706385E289B0B25631197D194B5C238BEB136FB".from_hex().unwrap(),
        "cfx-test:1k072e1j7s0fmky14b9vgpwp53n822tz70bgce2y52dgp9b326bx355ns8wbxc9pzcnkhzw53z",
    );
}
...
fn testnet_48byte() {
    ...
    verify(
        Network::Test,
        &"E361CA9A7F99107C17A622E047E3745D3E19CF804ED63C5C40C6BA763696B98241223D8CE62AD48D863F4CB18C930E4C".from_hex().unwrap(),
        "cfx-test:1rhp3jmufych0z0rmshe0hz3ehekw6efg17dcf2w833bmxhpjuws4g927p6ecapmhp33yk5hhj9gwk0avtmwuua",
    );
}
...
fn testnet_56byte() {
    ...
    verify(
        Network::Test,
        &"D9FA7C4C6EF56DC4FF423BAAE6D495DBFF663D034A72D1DC7D52CBFE7D1E6858F9D523AC0A7A5C34077638E4DD1A701BD017842789982041".from_hex().unwrap(),
        "cfx-test:1vczmz2cdvupvh7z88xuntpmjrdzythx0d575mewfn9crzkx3tm5hyen4ep0myjw6g3rce74vmd706yg2y22f2cs410gta8u7nb5",
    );
}
#[test]
fn testnet_64byte() {
    ...
    verify(
        Network::Test,
        &"D0F346310D5513D9E01E299978624BA883E6BDA8F4C60883C10F28C2967E67EC77ECC7EEEAEAFC6DA89FAD72D11AC961E164678B868AEEEC5F2C1DA08884175B".from_hex().unwrap(),
        "cfx-test:1z8f6hhh1nah7pf03smtjy329em87tnxn3ucc243s47jhgmpftkysxzcszrenurwdpm9zbbju4dcjsf1chksr1maxvp5yb0xm24885uvasgp6b1e",
    );
}
