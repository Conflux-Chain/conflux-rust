...
#[bench]
fn iter_100(b: &mut Bencher) { bench(100, Seq, b); }

#[bench]
fn iter_1000(b: &mut Bencher) { bench(1000, Seq, b); }

#[bench]
fn iter_10000(b: &mut Bencher) { bench(10000, Seq, b); }

#[bench]
fn iter_100000(b: &mut Bencher) { bench(100000, Seq, b); }

#[bench]
fn iter_1000000(b: &mut Bencher) { bench(1000000, Seq, b); }
...
mod par {
    ...
    #[bench]
    fn par_iter_3_100(b: &mut Bencher) { bench(100, Par(3), b); }

    #[bench]
    fn par_iter_3_1000(b: &mut Bencher) { bench(1000, Par(3), b); }

    #[bench]
    fn par_iter_3_10000(b: &mut Bencher) { bench(10000, Par(3), b); }

    #[bench]
    fn par_iter_3_100000(b: &mut Bencher) { bench(100000, Par(3), b); }

    #[bench]
    fn par_iter_3_1000000(b: &mut Bencher) { bench(1000000, Par(3), b); }

    #[bench]
    fn par_iter_2_100(b: &mut Bencher) { bench(100, Par(2), b); }

    #[bench]
    fn par_iter_2_1000(b: &mut Bencher) { bench(1000, Par(2), b); }

    #[bench]
    fn par_iter_2_10000(b: &mut Bencher) { bench(10000, Par(2), b); }

    #[bench]
    fn par_iter_2_100000(b: &mut Bencher) { bench(100000, Par(2), b); }

    #[bench]
    fn par_iter_2_1000000(b: &mut Bencher) { bench(1000000, Par(2), b); }
