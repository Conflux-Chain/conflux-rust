...
build_config! {
    {
        ...
        // V3.0
        (eoa_code_transition_height, (Option<u64>), Some(48580000))
        ...
        // V3.1
        (osaka_opcode_transition_height, (Option<u64>), Some(25960000))
        ...
        (max_difficulty_guard, (Option<U256>), Some(U256::from(5000u64)))
        (max_finalize_confirmation_guard, (Option<u64>), Some(3000))
        ...
        (pos_cip173_transition_view, (u64), 653580)
