...
use cfx_types::{U64, H256, Address, U256, H64};
use cfx_rpc_primitives::Bytes;
use cfx_rpc_eth_types::{BlockNumber as BlockId, SyncStatus, Block, Receipt, Transaction, TransactionRequest, Header};
...
pub trait EthApi {
    ...
    async fn block_receipts(&self, block_id: BlockId) -> RpcResult<Option<Vec<Receipt>>>;

    /// Returns an uncle block of the given block and index.
    #[method(name = "getUncleByBlockHashAndIndex")]
    async fn uncle_by_block_hash_and_index(&self, hash: H256, index: Index)
    ...
    async fn raw_transaction_by_hash(&self, hash: H256) -> RpcResult<Option<Bytes>>;
