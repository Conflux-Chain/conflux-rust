...
mod tests {
    ...
    fn serde_txpool_content() {
        ...
        // Addresses used as keys in `pending` and `queued` have been manually
        // lowercased to simplify the test.
  ...
  "queued": {
    ...
    "0x02666081cfb787de3562efbbca5f0fe890e927f1": {
      "44": {
        ...
        let deserialized: TxpoolContent =
        ...
        let serialized_value =
            serde_json::to_value(deserialized.clone()).unwrap();
