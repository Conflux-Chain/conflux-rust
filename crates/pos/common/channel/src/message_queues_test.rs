...
fn test_fifo() {
    let mut q =
        PerKeyQueue::new(QueueStyle::FIFO, NonZeroUsize::new(3).unwrap());
...
fn test_lifo() {
    let mut q =
        PerKeyQueue::new(QueueStyle::LIFO, NonZeroUsize::new(3).unwrap());
    let validator = AccountAddress::new([0u8; AccountAddress::LENGTH]);
...
fn test_klast() {
    let mut q =
        PerKeyQueue::new(QueueStyle::KLAST, NonZeroUsize::new(3).unwrap());
    let validator = AccountAddress::new([0u8; AccountAddress::LENGTH]);
