...
mod tests {
    ...
    fn test_large_values_in_override() {
        ...
        let acc = state_override
            .get(
                &Address::from_str("1234567890123456789012345678901234567890")
                    .unwrap(),
            )
            .unwrap();
    ...
    fn test_state_override() {
        ...
        let acc = state_override
            .get(
                &Address::from_str("0000000000000000000000000000000000000124")
                    .unwrap(),
            )
            .unwrap();
    ...
    fn test_state_override_state_diff() {
        ...
        let acc = state_override
            .get(
                &Address::from_str("1b5212AF6b76113afD94cD2B5a78a73B7d7A8222")
                    .unwrap(),
            )
            .unwrap();
