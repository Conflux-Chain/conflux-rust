...
#[repr(u8)]
#[derive(
    Clone, Copy, Debug, Default, PartialEq, Eq, PartialOrd, Ord, Hash, enumn::N,
)]
...
pub enum SpecId {
    ...
    CONSTANTINOPLE,   /* Constantinople         7280000 is overwritten with
                       * PETERSBURG */
    ...
    MERGE,         /* Paris/Merge            15537394 (TTD:
