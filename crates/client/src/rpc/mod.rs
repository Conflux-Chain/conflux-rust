...
pub fn setup_public_rpc_apis(
    ...
    eth_pubsub: EthPubSubClient, conf: &Configuration, executor: Arc<Runtime>,
...
fn setup_rpc_apis(
    ...
    throttling_section: &str, apis: HashSet<Api>, executor: Arc<Runtime>,
) -> MetaIoHandler<Metadata> {
...
pub async fn launch_async_rpc_servers(
    ...
    addr: Option<SocketAddr>, executor: Arc<Runtime>,
