...
build_config! {
    {
        ...
        (unnamed_21autumn_transition_number, (Option<u64>), Some(129600))
        (unnamed_21autumn_transition_height, (Option<u64>), Some(100000))
        ...
        (pos_reference_enable_height, (u64), 270000)
