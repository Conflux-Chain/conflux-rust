...
impl RpcImpl {
    ...
    fn prepare_transaction(
        ...
        if tx.nonce.is_none() {
            // The "next_nonce" for the address could result into an
            // invalid_params error, because the address is from
            // invalid address space. For an invalid_params error,
            // the name of the params should be provided.
