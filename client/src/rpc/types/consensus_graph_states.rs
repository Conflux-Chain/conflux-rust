...
mod tests {
    ...
    fn test_consensus_graph_states_serialize() {
        ...
        assert_eq!(
            serialize2,
            "{\"blockStateVec\":[],\"blockExecutionStateVec\":[]}"
        );
    }
    #[test]
    fn test_consensus_graph_states_deserialize() {
        ...
        let deserialize: ConsensusGraphStates =
    ...
    fn test_consensus_graph_states_new() {
        ...
        let consensus_graph_states =
            ConsensusGraphStates::new(pri_consensus_graph_states);
        let consensus_graph_states_info =
            serde_json::to_string(&consensus_graph_states).unwrap();
