...
use cfx_types::{U128 as CfxU128, U256 as CfxU256, U64 as CfxU64};
use serde;
            ...
            where D: serde::Deserializer<'a> {
                ...
                impl<'b> serde::de::Visitor<'b> for UintVisitor {
                    ...
                    where E: serde::de::Error {
                        ...
                        $other::from_str(&value[2..]).map($name).map_err(|e| {
                            E::custom(&format!("invalid hex value: {:?}", e))
                        })
                    }
...
impl_uint!(U128, CfxU128, 2);
impl_uint!(U256, CfxU256, 4);
impl_uint!(U64, CfxU64, 1);
...
mod tests {
    ...
    fn should_fail_to_deserialize_decimals() {
        ...
        let deserialized5: Res =
            serde_json::from_str(r#""1000000000000000000""#);
