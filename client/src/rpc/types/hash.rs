...
use cfx_types::{
    Bloom as Cfx2048, H160 as Cfx160, H256 as Cfx256, H512 as Cfx512,
    H520 as Cfx520, H64 as Cfx64,
};
...
impl_hash!(H64, Cfx64, 8);
impl_hash!(H160, Cfx160, 20);
impl_hash!(H256, Cfx256, 32);
impl_hash!(H512, Cfx512, 64);
impl_hash!(H520, Cfx520, 65);
impl_hash!(H2048, Cfx2048, 256);
