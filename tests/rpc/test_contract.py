...
class TestContract(RpcClient):
    def test_contract_deploy(self) -> str:
        ...
        tx = self.new_contract_tx("",
                                  "")
    ...
    def test_contract_call(self):
        ...
        tx = self.new_contract_tx(contract_addr,
        ...
        tx2 = self.new_contract_tx(contract_addr,
        ...
        assert_equal(int(self.call(contract_addr, "0x6d4ce63c", nonce=old_nonce, epoch=self.EPOCH_NUM(old_epoch)), 0),
                     6)
