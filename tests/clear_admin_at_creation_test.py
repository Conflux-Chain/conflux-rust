...
class ClearAdminTest(ConfluxTestFramework):
    ...
    def run_test(self):
        ...
        nonce += 1
        self.rpc.send_tx(tx_create, True)
        _receipt = self.rpc.get_transaction_receipt(tx_create.hash_hex())
        ...
        clear_admin_test_contract_addr = "0x" + self.rpc.call(create2factory_addr, data)[-40:]
        # Deploy the contract.
        self.call_contract(genesis_addr, genesis_key, create2factory_addr, data, value=0, storage_limit=2048)
