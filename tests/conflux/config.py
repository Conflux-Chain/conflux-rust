...
default_config = dict(
    ...
    GENESIS_STATE_ROOT=decode_hex("0x867d0d102ed7eb638e25ab718c4ac4ba3d7fa0d87748382d9580b25f608dc80a"),
    ...
    GENESIS_AUTHOR=decode_hex("0x1000000000000000000000000000000000000064"),
