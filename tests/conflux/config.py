...
default_config = dict(
    ...
    GENESIS_STATE_ROOT=decode_hex("0x0490754bf55a8030b19bf0f6536559700a01a0a9b7ce107977c507138e1bf0bd"),
    ...
    GENESIS_AUTHOR=decode_hex("0x000000000000000000000000000000000000000d"),
)
