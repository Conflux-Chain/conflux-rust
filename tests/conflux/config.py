...
default_config = dict(
    ...
    GENESIS_AUTHOR=decode_hex("0x2000000000000000000000000000000000000102"),
    GENESIS_TRANSACTION_ROOT=decode_hex("0xc4e6128ef94075d5e6a13fd40e7196041f3b90b3f1f7e9c830bf14277964a41f"),
