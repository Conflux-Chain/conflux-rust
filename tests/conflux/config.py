...
default_config = dict(
    ...
    GENESIS_STATE_ROOT=decode_hex("0x667d3aa39c3d3542c76929437afba888eab2f5197189011ed548dfb6b4b60f51"),
    ...
    GENESIS_AUTHOR=decode_hex("0x000000000000000000000000000000000000000e"),
)
