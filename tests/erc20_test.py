...
class P2PTest(ConfluxTestFramework):
    ...
    def run_test(self):
        ...
        for i in range(tx_n):
            ...
            tx_data = decode_hex(erc20_contract.functions.transfer(Web3.to_checksum_address(encode_hex(priv_to_addr(receiver_sk))), value).buildTransaction(self.tx_conf)["data"])
    ...
    def get_balance(self, contract, token_address):
        tx = contract.functions.balanceOf(Web3.to_checksum_address(encode_hex(token_address))).buildTransaction(self.tx_conf)
